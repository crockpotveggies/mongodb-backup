...
MONGODB_HOST=${PRODUCTION_DB_MONGO_PORT_27017_TCP_ADDR:-${MONGODB_HOST}}
MONGODB_HOST=${PRODUCTION_DB_MONGO_PORT_1_27017_TCP_ADDR:-${MONGODB_HOST}}
MONGODB_PORT=${PRODUCTION_DB_MONGO_PORT_27017_TCP_PORT:-${MONGODB_PORT}}
MONGODB_PORT=${PRODUCTION_DB_MONGO_PORT_1_27017_TCP_PORT:-${MONGODB_PORT}}
MONGODB_USER=${PRODUCTION_DB_MONGO_USER:-${MONGODB_ENV_MONGODB_USER}}
MONGODB_PASS=${PRODUCTION_DB_MONGO_PASS:-${MONGODB_ENV_MONGODB_PASS}}
